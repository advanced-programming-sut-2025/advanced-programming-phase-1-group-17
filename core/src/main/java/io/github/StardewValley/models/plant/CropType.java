...
public enum CropType implements BackPackableType {
    ...
    Hops(SeedType.HopsStarter, List.of(1, 1, 2, 3, 4), 11, false, 1, 25, true, 45, List.of(Season.Summer), false,
        new String[] {"Crops/Hops_Stage_1.png", "Crops/Hops_Stage_2.png", "Crops/Hops_Stage_3.png", "Crops/Hops_Stage_4.png", "Crops/Hops_Stage_5.png"}, "Crops/Hops.png"),
    HotPepper(SeedType.PepperSeeds, List.of(1, 1, 1, 1, 1), 5, false, 3, 40, true, 13, List.of(Season.Summer), false,
        new String[] {"Crops/HotPepper_Stage_1.png", "Crops/HotPepper_Stage_2.png", "Crops/HotPepper_Stage_3.png", "Crops/HotPepper_Stage_4.png", "Crops/HotPepper_Stage_5.png"}, "Crops/HotPepper.png"),
    ...
    RedCabbage(SeedType.RedCabbageSeeds, List.of(2, 1, 2, 2, 2), 9, true, -1, 260, true, 75, List.of(Season.Summer), false,
        new String[] {"Crops/RedCabbage_Stage_1.png", "Crops/RedCabbage_Stage_2.png", "Crops/RedCabbage_Stage_3.png", "Crops/RedCabbage_Stage_4.png", "Crops/RedCabbage_Stage_5.png"}, "Crops/RedCabbage.png"),
    ...
    SummerSpangle(SeedType.SpangleSeeds, List.of(1, 2, 3, 1), 8, true, -1, 90, true, 45, List.of(Season.Summer), false,
        new String[] {"Crops/SummerSpangle_Stage_1.png", "Crops/SummerSpangle_Stage_2.png", "Crops/SummerSpangle_Stage_3.png", "Crops/SummerSpangle_Stage_4.png"}, "Crops/SummerSpangle.png"),
    SummerSquash(SeedType.SummerSquashSeeds, List.of(1, 1, 1, 2, 1), 6, false, 3, 45, true, 63, List.of(Season.Summer), false,
        new String[] {"Crops/SummerSquash_Stage_1.png", "Crops/SummerSquash_Stage_2.png", "Crops/SummerSquash_Stage_3.png", "Crops/SummerSquash_Stage_4.png", "Crops/SummerSquash_Stage_5.png"}, "Crops/SummerSquash.png"),
    ...
    BokChoy(SeedType.BokChoySeeds, List.of(1, 1, 1, 1), 4, true, -1, 80, true, 25, List.of(Season.Fall), false,
        new String[] {"Crops/BokChoy_Stage_1.png", "Crops/BokChoy_Stage_2.png", "Crops/BokChoy_Stage_3.png", "Crops/BokChoy_Stage_4.png"}, "Crops/BokChoy.png"),
    ...
    Cranberries(SeedType.CranberrySeeds, List.of(1, 2, 1, 1, 2), 7, false, 5, 75, true, 38, List.of(Season.Fall), false,
        new String[] {"Crops/Cranberries_Stage_1.png", "Crops/Cranberries_Stage_2.png", "Crops/Cranberries_Stage_3.png", "Crops/Cranberries_Stage_4.png", "Crops/Cranberries_Stage_5.png"}, "Crops/Cranberries.png"),
    ...
    FairyRose(SeedType.FairySeeds, List.of(1, 4, 4, 3), 12, true, -1, 290, true, 45, List.of(Season.Fall), false,
        new String[] {"Crops/FairyRose_Stage_1.png", "Crops/FairyRose_Stage_2.png", "Crops/FairyRose_Stage_3.png", "Crops/FairyRose_Stage_4.png"}, "Crops/FairyRose.png"),
    Grape(SeedType.GrapeStarter, List.of(1, 1, 2, 3, 3), 10, false, 3, 80, true, 38, List.of(Season.Fall), false,
        new String[] {"Crops/Grape_Stage_1.png", "Crops/Grape_Stage_2.png", "Crops/Grape_Stage_3.png", "Crops/Grape_Stage_4.png", "Crops/Grape_Stage_5.png"}, "Crops/Grape.png"),
    Pumpkin(SeedType.PumpkinSeeds, List.of(1, 2, 3, 4, 3), 13, true, -1, 320, false, -1, List.of(Season.Fall), true,
        new String[] {"Crops/Pumpkin_Stage_1.png", "Crops/Pumpkin_Stage_2.png", "Crops/Pumpkin_Stage_3.png", "Crops/Pumpkin_Stage_4.png", "Crops/Pumpkin_Stage_5.png"}, "Crops/Pumpkin.png"),
    Yam(SeedType.YamSeeds, List.of(1, 3, 3, 3), 10, true, -1, 160, true, 45, List.of(Season.Fall), false,
        new String[] {"Crops/Yam_Stage_1.png", "Crops/Yam_Stage_2.png", "Crops/Yam_Stage_3.png", "Crops/Yam_Stage_4.png"}, "Crops/Yam.png"),
    SweetGemBerry(SeedType.RareSeed, List.of(2, 4, 6, 6, 6), 24, true, -1, 3000, false, -1, List.of(Season.Fall), false,
        new String[] {"Crops/SweetGemBerry_Stage_1.png", "Crops/SweetGemBerry_Stage_2.png", "Crops/SweetGemBerry_Stage_3.png", "Crops/SweetGemBerry_Stage_4.png", "Crops/SweetGemBerry_Stage_5.png"}, "Crops/SweetGemBerry.png"),
