...
public enum ArtisanProductType implements BackPackableType {
    ...
    Beer("Beer", 50, 1, 0,
        mapOf(entry(io.github.StardewValley.models.plant.CropType.Wheat, 1)), 200, CraftingItemType.Keg),

    Coffee("Coffee", 75, 0, 2,
        mapOf(entry(io.github.StardewValley.models.plant.CropType.CoffeeBean, 5)), 150, CraftingItemType.Keg),
