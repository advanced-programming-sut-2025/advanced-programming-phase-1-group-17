...
//        ranch.addAnimal(new ShopItem(AnimalType.Chicken, "Well cared-for chickens lay eggs every day. Lives in the coop.", 800, Ani2));
...
//        ranch.addAnimal(new AnimalItem(AnimalType.Pig, "These pigs are trained to find truffles! Lives in the barn.", 16000, AnimalHabitat.Barn, 2));
        ...
        //pierre.addNormaItem(new ShopItem(CraftingItemType.Vinegar, 200, Integer.MAX_VALUE, "An aged fermented liquid used in many cooking recipes."));
