...
public enum ArtisanProductType implements BackPackableType {
    ...
    Beer("Beer", 50, 1, 0,
        mapOf(entry(CropType.Wheat, 1)), 200, CraftingItemType.Keg),
    ...
    Pale_Ale("Pale Ale", 50, 3, 0,
        mapOf(entry(CropType.Hops, 1)), 300, CraftingItemType.Keg),
    ...
    Oil("Oil", 13, 2, 0,
        mapOf(entry(CropType.Corn, 1)), 100, CraftingItemType.OilMaker),
